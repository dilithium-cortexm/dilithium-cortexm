...
extern void ntt_fast_m3(int16_t *, const int16_t *);
/*************************************************
* Name:        ntt
*
...
void ntt(int16_t *poly) {
    ntt_fast_m3(poly, zetas_asm);
}

extern void invntt_fast_m3(int16_t *, const int16_t *);
/*************************************************
* Name:        invntt
*
...
void invntt(int16_t *poly) {
    invntt_fast_m3(poly, zetas_inv_asm);
}
